...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.api_id'
        db.add_column(u'message_api_message', 'api_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.api_id'
        db.delete_column(u'message_api_message', 'api_id')


    models = {
        u'message_api.message': {
            'Meta': {'object_name': 'Message'},
            'api_id': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
